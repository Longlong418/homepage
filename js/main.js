...
const add_id = "igowcyrfjmehwiqc"; // app_id
const app_secret = "SHhEQlQzTDN4VUJQMDgvMER2dUJpUT09"; // app_secret
const key = "388e86ca412841f3820f414ab7f656cb" // key
function getWeather() {
...
`
let title1 = 'Longlong'
let title2 = `很感谢互联网上分享开源项目的作者们！`
let content = `
非常感谢该作者的更新，在原主题基础上进行了更新,让我这种小白也很容易去打理自己的博客
以下是原作者的信息
版 本 号：3.4
更新日期：2022-07-24
主页:  https://www.slass.cc
Github:  https://github.com/poshoi
`
